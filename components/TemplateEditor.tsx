        ...
        <div className="space-y-6 overflow-y-auto pr-2 custom-scrollbar">
          <div className="bg-[#111] border border-white/10 rounded-xl p-5 shadow-lg">
            ...
            <textarea 
              ...
              className="w-full bg-black/50 border border-white/10 rounded-lg p-3 text-sm text-gray-300 focus:border-violet-500 outline-none resize-y min-h-[120px]" 
            />
          </div>
          <div className="bg-[#111] border border-white/10 rounded-xl p-5 shadow-lg">
          ...
          {isRiskMode && (
            <div className="bg-red-900/10 border border-red-500/30 rounded-xl p-5 animate-in fade-in slide-in-from-left-4">
              ...
              <textarea 
                ...
                className="w-full bg-black/50 border border-red-500/20 rounded-lg p-3 text-sm text-gray-300 focus:border-red-500 outline-none resize-y min-h-[100px]" 
              />
            </div>
          )}
        </div>
                    ...
                    <div className="flex-1 w-full space-y-3">
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                className="w-full bg-white/5 rounded-md p-2 text-xs text-gray-300 outline-none resize-y min-h-[50px] focus:ring-1 focus:ring-violet-500/50 border border-transparent focus:border-violet-500/30" 
                        ...
                        {isRiskMode && (
                            <div className="animate-in fade-in slide-in-from-top-2">
                                ...
                                <textarea 
                                    ...
                                    className="w-full bg-red-900/10 border border-red-500/10 rounded-md p-2 text-xs text-gray-300 outline-none resize-y min-h-[50px] focus:border-red-500/50" 
