...
**Still not done, four stages on, and still the largest gap in this file. No credentials
were entered.** Stage 4's screens are in exactly the same position as every screen before
them: the conflict notice, the held-update line, the stale banner and its dead controls,
the presence roster and its clause marker, the assign panel and the "asked of you" panel
...
has checked this"*, and whether a refusal reads as an error rather than as a decision, are
